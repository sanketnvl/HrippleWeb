	...
	public ModelAndView Life_at_HRipple_Solutions() {
	 ...
	 @RequestMapping(value = "/echofile", method = RequestMethod.POST)
	    public @ResponseBody String echoFile(MultipartHttpServletRequest request,
	            HttpServletResponse response,@RequestParam(value = "section") String section,@RequestParam(value = "action") String action) throws Exception {
	...
	String uploadFileHandler(@RequestParam("name") String name,
		...
		if (!file.isEmpty()) {
			try {
				...
				if (!dir.exists())
					dir.mkdirs();
				fileName=file.getName()+"_"+randomString(10)+"."+FilenameUtils.getExtension(file.getOriginalFilename());;
				...
				String body = "Hello," + "<br/><br/><p><b>This is an automated system email. please do not reply to this email</b></p>";
	 ...
	 @RequestMapping(value = "/sendEmailWithResume", method = RequestMethod.POST)
	    public @ResponseBody String sendEmailWithResume(MultipartHttpServletRequest request,
	            HttpServletResponse response,
	            @RequestParam(value = "name") String name,
	            @RequestParam(value = "loc") String loc,
	            @RequestParam(value = "add") String add,
	            @RequestParam(value = "dob") String dob,
	            @RequestParam(value = "co") String co,
	 ...
	 /*       Long size = multipartFile.getSize();
			...
			fileName=multipartFile.getName()+"_"+randomString(10)+"."+FilenameUtils.getExtension(multipartFile.getOriginalFilename());;
			// Create the file on server
			File serverFile = new File(dir.getAbsolutePath()
					+ File.separator + fileName);
			...
			String body = "<b>Hello</b>," + "<br/><br/><p><b>Note=This is a system generated email, hit send button to reach the inbox of HRipple Solutions! </b></p><p>Name:"+name+"</p><p>Location:"+loc+"</p><p>Address:"+add+"</p><p>Dob:"+dob+"</p><p>Current Organization:"+co+"</p><p>Current Designation:"+cd+"</p><p>Last Education:"+le+"</p><p>Current Salary:"+cs+"</p><p>Conatct Number:"+cn+"</p><p>Email:"+email+"</p><br><br><p><b>Warm regards</b>,<p><b>Team Hripple</b></p>";
